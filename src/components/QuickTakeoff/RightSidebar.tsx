  ...
  return (
    ...
    >
      ...
      <QuickTakeoffToolbar
        ...
        trenchConfig={trenchConfig as any}
        onClearTrenchConfig={onClearTrenchConfig}
        boreShotConfig={boreShotConfig as any}
        onClearBoreShotConfig={onClearBoreShotConfig}
        conduitConfig={conduitConfig as any}
        onClearConduitConfig={onClearConduitConfig}
        hydroExcavationConfig={hydroExcavationConfig as any}
        onClearHydroExcavationConfig={onClearHydroExcavationConfig}
        vaultConfig={vaultConfig as any}
